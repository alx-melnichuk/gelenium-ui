...
@Component({
  selector: 'app-pl-snackbar-material-ui',
  templateUrl: './pl-snackbar-material-ui.component.html',
  styleUrls: ['./pl-snackbar-material-ui.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PlSnackbarMaterialUiComponent {
  @Input()
