...
@Component({
  selector: 'app-pl-snackbar-bootstrap',
  templateUrl: './pl-snackbar-bootstrap.component.html',
  styleUrls: ['./pl-snackbar-bootstrap.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PlSnackbarBootstrapComponent {
  @Input()
