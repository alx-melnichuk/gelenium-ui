...
import { PlCalendarMatModule } from '../pl-calendar-mat/pl-calendar-mat.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    PlCalendarBasicModule,
    PlCalendarBootstrapModule,
    PlCalendarMaterialUiModule,
    PlCalendarMatModule,
    PlCalendarRoutingModule,
  ],
